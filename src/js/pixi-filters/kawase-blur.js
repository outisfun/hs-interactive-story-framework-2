...
var fragment = require('pixi-filters/fragment-kawase-blur.js');
var fragmentClamp = require('pixi-filters/fragment-kawase-blur-clamp.js');
...
class KawaseBlurFilter extends PIXI.Filter {
    constructor(blur = 1, quality = 10, clamp = false) {
...
module.exports = KawaseBlurFilter;
